...
class income:
    ...
    def __init__(self,email):
        self.email = email
        self.top=Toplevel()
        self.top.title("View Income")
        self.top.label_3 = Label(self.top, text="Incomes",font=("Constantia", "25", "italic", 'bold')).pack(side=TOP,pady=20)
        ...
        cr = conn.cursor()
        q = f'select  id,amount,payer,remarks,category,transectiontype from income where emailId ="{self.email}"'
        cr.execute(q)
